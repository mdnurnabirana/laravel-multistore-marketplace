                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="sub_cat_two" class="form-control sub-category">
                                <option value="">Select</option>
                                @if(isset($popularCategorySection[1]) && isset($popularCategorySection[1]->category))
                                    @php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="child_cat_two" class="form-control child-category">
                                <option value="">Select</option>
                                @if(isset($popularCategorySection[1]) && isset($popularCategorySection[1]->sub_category))
                                    @php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="sub_cat_three" class="form-control sub-category">
                                <option value="">Select</option>
                                @if(isset($popularCategorySection[2]) && isset($popularCategorySection[2]->category))
                                    @php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="child_cat_three" class="form-control child-category">
                                <option value="">Select</option>
                                @if(isset($popularCategorySection[2]) && isset($popularCategorySection[2]->sub_category))
                                    @php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="sub_cat_four" class="form-control sub-category">
                                <option value="">Select</option>
                                @if(isset($popularCategorySection[3]) && isset($popularCategorySection[3]->category))
                                    @php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="child_cat_four" class="form-control child-category">
                                <option value="">Select</option>
                                @if(isset($popularCategorySection[3]) && isset($popularCategorySection[3]->sub_category))
                                    @php
