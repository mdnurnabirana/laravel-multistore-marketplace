      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown {{ setActive([
          ...
          'admin.child-category.*'
            ...
            <a href="{{ route('admin.category.index') }}" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Manage Categories</span></a>
        ...
        <li class="dropdown {{ setActive([
          'admin.brand.*', 'admin.products.*', 'admin.products-image-gallery.*', 'admin.products-variant.*',
          'admin.products-variant-item.*', 'admin.seller-products.*', 'admin.seller-products.*'
        ])}}">
        ...
        <li class="dropdown {{ setActive([
          'admin.vendor-profile.*', 'admin.flash-sale.*', 'admin.coupons.*', 'admin.shipping-rule.*', 'admin.admin-settings.*'
        ])}}">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="{{setActive(['admin.admin-settings.*'])}}"><a class="nav-link" href="{{ route('admin.payment-settings.index')}}">Payment Settings</a></li>
          </ul>
        </li>
