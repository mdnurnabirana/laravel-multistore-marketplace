        ...
        <div class="card-body">
            <form action="{{ route('admin.homepage-banner-section-three') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="banner_one_old_image" value="{{ @$homepage_section_banner_three->banner_one->banner_image }}">
                </div>
                <div class="form-group">
                    <label>Banner Url</label>
                    <input type="text" name="banner_one_url" class="form-control" value="{{ @$homepage_section_banner_three->banner_one->banner_url }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="banner_two_old_image" value="{{ @$homepage_section_banner_three->banner_two->banner_image }}">
                </div>
                <div class="form-group">
                    <label>Banner Url</label>
                    <input type="text" name="banner_two_url" class="form-control" value="{{ @$homepage_section_banner_three->banner_two->banner_url }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="banner_three_old_image" value="{{ @$homepage_section_banner_three->banner_three->banner_image }}">
                </div>
                <div class="form-group">
                    <label>Banner Url</label>
                    <input type="text" name="banner_three_url" class="form-control" value="{{ @$homepage_section_banner_three->banner_three->banner_url }}">
                </div>
