        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                   <a href="{{ route('vendor.products-variant.index', ['product' => $variant->product_id]) }}" class="btn btn-primary mb-3">Back</a>
                   <div class="dashboard_content mt-2 mt-md-0">
                        <h3><i class="fas fa-plus-circle"></i> Update Variant</h3>
