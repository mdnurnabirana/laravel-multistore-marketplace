        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                   <a href="{{ route('vendor.products-variant-item.index', ['productId' => $product->id , 'variantId' => $variant->id])}}" class="btn btn-primary mb-3"><i class="fas fa-arrow-left me-2"></i>Back</a>
                   <div class="dashboard_content mt-2 mt-md-0">
                        <h3><i class="fas fa-plus-circle"></i> Create Variant Item</h3>
