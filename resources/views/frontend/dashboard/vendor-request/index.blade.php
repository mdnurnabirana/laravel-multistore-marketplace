                            ...
                            <div class="wsus__dash_pro_area">
                                <form action="">
                                   <div class="wsus__dash_pro_single" bis_skin_checked="1">
                                        ...
                                        <input type="file" placeholder="Shop Banner Image" name="shop_image" value="">
                                    </div>
                                    <div class="wsus__dash_pro_single" bis_skin_checked="1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="wsus__dash_pro_single" bis_skin_checked="1">
                                                ...
                                                <input type="text" placeholder="Shop Email" name="shop_email" value="">
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="wsus__dash_pro_single" bis_skin_checked="1">
                                                <i class="fas fa-phone" aria-hidden="true"></i>
                                                <input type="text" placeholder="Shop Phone" name="shop_phone" value="">
                                              </div>
                                        </div>
                                    </div>
                                    <div class="wsus__dash_pro_single" bis_skin_checked="1">
