                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-left:auto;" class="common_btn" type="button">
                                add new address
                            </a>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $('#submitCheckoutForm').on('click', function(e){
                ...
                if($('#shipping_method_id').val() == ""){
                    ...
                    toastr.error('You have to agree to Terms and Condition for place order!');
                }else{
                    $.ajax({
                        ...
                        beforeSend: function(){
                            $('#submitCheckoutForm').html('<i class="fas fa-spinner fa-spin fa-2x"></i>')
                        },
