                    ...
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        <form class="tack_form" action="{{ route('product-tracking.index') }}" method="GET">
                            ...
                            <div class="wsus__track_input">
                                ...
                                <input type="text" name="tracker" placeholder="121121"
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-sm-6 col-lg-3">
                                            <div class="wsus__track_header_single">
                                                <h5>Order Date</h5>
                                                <p>{{ @$order->created_at ? @$order->created_at->format('d M Y') : '' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-sm-6 col-lg-3">
                                            <div class="wsus__track_header_single">
                        ...
                        <div class="col-xl-12">
                            <ul class="progtrckr" data-progtrckr-steps="4">
                                ...
                                @if (@$order->order_status == 'cancelled')
                                    <li class="progtrckr_done icon_two red_mark">Order Cancelled</li>
                                @else
                                    <li
