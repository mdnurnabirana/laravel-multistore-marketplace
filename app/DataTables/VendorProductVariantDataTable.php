...
class VendorProductVariantDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $variantItems = "<a href='".route('vendor.products-variant-item.index', ['productId' => request('product'), 'variantId' => $query->id])."' class='btn btn-info me-1'><i class='far fa-edit'></i>Variant Items</a>";
        
        // Edit Button
        $editBtn = "<a href='".route('vendor.products-variant.edit', $query->id)."' class='btn btn-primary'><i class='far fa-edit'></i></a>";
        
        // Delete Button
        $dltBtn = "<a href='".route('vendor.products-variant.destroy', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
        
        // Return the combined action buttons
        return $variantItems . $editBtn . $dltBtn;
        })
    ...
    {
        return [
            Column::make('id')->addClass('text-center')->width(200),
            Column::make('name')->addClass('text-center')->width(400),
            Column::make('status')->addClass('text-center')->width(400),
