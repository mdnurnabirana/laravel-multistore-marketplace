...
class ProductVarientItemDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query) {
            ...
            // Delete Button
            $dltBtn = "<a href='".route('admin.products-variant-item.destroy', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
    ...
    {
        return $this->builder()
                    ->setTableId('productvarientitem-table')
    ...
    {
        return 'ProductVarientItem_' . date('YmdHis');
    }
}
