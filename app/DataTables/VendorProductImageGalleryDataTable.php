...
class VendorProductImageGalleryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            {
                $dltBtn = "<a href='".route('vendor.products-image-gallery.destroy', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";

                return $dltBtn;
            })
            ->addColumn('image', function($query){
                return "<img width='150px' height='100px' src='" . asset($query->image) . "' />";
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('image')->width(300)->addClass('text-center'),
